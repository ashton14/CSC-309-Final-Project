...
public class MenuBarControlHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (e.getActionCommand()) {
            ...
            case "Undo" -> drawableData.undo();
            case "Clear" -> drawableData.clear();
            case "Delete" -> stateData.deleteSelectedItem();
            case "Sandbox" -> stateData.changeMode("Sandbox");
            case "Translate Code" -> stateData.changeMode("Translate Code");
            case "Translate Flowchart" -> stateData.changeMode("Translate Flowchart");
        }
